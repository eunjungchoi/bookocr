...
function GoogleBooksAuth(apiKey, options) {
    this.apiKey = apiKey;

    var googleRequestUrl = 'https://content.googleapis.com/books/v1/volumes?key=' + this.apiKey + '&maxResults=20&orderBy=relevance&q=%s';
...
GoogleBooksAuth.prototype = _.create(Bloodhound.prototype);

// override
GoogleBooksAuth.prototype.initialize = function() {
...
GoogleBooksAuth.prototype.prepare = function(query, settings) {
    this.query   = query;
